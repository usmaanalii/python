...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        print "mission is to get the neutron destruct bomb \
               from the Weapons Armory,"
        print "put it in the bridge, and blow the ship \
               up after getting into an "
        print "escape pod."
        print "\n"
        print "You're running down the central corridor to \
               the Weapons Armory when"
        print "a Gothon jumps out, red scaly skin, dark grimy teeth, \
        ...
        if action == "shoot!":
            ...
            print "makes him fly into a rage and blast you \
            ...
            print "Lbhe zbgure vf fb sng, jura fur fvgf \
                   nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
            print "The Gothon stops, tries not to laugh, \
                   then busts out laughing and can't move."
            print "While he's laughing you run up and \
                   shoot him square in the head"
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print "You do a dive roll into the \
               Weapon Armory, crouch and scan the room"
        ...
        if guess == code:
            print "The container clicks open \
                   and the seal breaks, letting gas out."
